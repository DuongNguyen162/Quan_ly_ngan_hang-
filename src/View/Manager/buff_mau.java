 ...
 * @author ADMIN
 */
public class buff_mau extends javax.swing.JDialog {

    /**
     * Creates new form PayAcc
     */
    public buff_mau(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(STK, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE))))
    ...
    private void btnNapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNapActionPerformed
        //if(tfMoney.getText()<="90000000"){
        try {
            BigInteger money = new BigInteger(tfMoney.getText());
            System.out.println(money);
            m.payAcc(new BigInteger(STK.getText()),money);
