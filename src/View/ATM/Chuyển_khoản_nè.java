 ...
 * @author Nguyen Duong
 */
public class Chuyển_khoản_nè extends javax.swing.JDialog {

    /**
     * Creates new form Transfer
     */
    public Chuyển_khoản_nè(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void transfer(){
        ...
        atmframe.transferMoney( receiver_cardID, money);
            ...
            JOptionPane.showMessageDialog(this, "Sai STK rùi nha!");
        }
    ...
    public boolean checkCardID(){
        ...
        if (atm.CheckCardID(cardID) == null) {
            lbNotiCheck.setText("STK không hợp lệ");
            return false;
        } else {
            lbNotiCheck.setText("STK của "+atm.CheckCardID(cardID));
            return true;
        }
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(tfCardID, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                            ...
                            .addComponent(tfMoney, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
...
int checkSD = atmframe.checkBlance().compareTo(new BigInteger(tfMoney.getText()));
        if (!tfCardID.getText().isEmpty()&&!tfMoney.getText().isEmpty()&&checkSD != 0 ) {  
          transfer();
} else { 
 
JOptionPane.showMessageDialog(this, "Không có tiền mà đòi chuyển à!");
